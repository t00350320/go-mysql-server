...
var _ sql.EvalableAggregation = (*JSONArrayAgg)(nil)
...
func (j *JSONArrayAgg) NewEvalable() (sql.WindowFunction, error) {
...
var _ sql.EvalableAggregation = (*JSONObjectAgg)(nil)
...
func (j *JSONObjectAgg) NewEvalable() (sql.WindowFunction, error) {
